...
CREATE USER gustavo WITH PASSWORD '202299415';
ALTER USER gustavo WITH SUPERUSER;
...
GRANT ALL ON DATABASE uvv gustavo;
ALTER DEFAULT PRIVILEGES
GRANT ALL ON TABLES TO gustavo;
...
/* Criando Schemas */
CREATE SCHEMA hr AUTHORIZATION gustavo;

SHOW SEARCH_PATH;
SELECT CURRENT_SCHEMA();
SET SEARCH_PATH TO hr, "\$user", public;
ALTER USER gustavo SET SEARCH_PATH TO hr, "\$user", public;
